...
$results = mysqli_query($con,"SELECT * FROM course NATURAL JOIN requirements WHERE major = 'BACS'");
                            ...
                            <div class="art-Post-body">
                                <div class="art-Post-inner">
                                    ...
                                    <div class="art-PostContent">
                                      ...
                                      <p>In addition to these required courses, BA CS majors must take 4 extra computing electives.  
                                          <?php
                                          echo "<table border='1'>
                                          <tr>
                                          <th>Course</th>
